...
Begin VB.Form IdeAcercaDe 
   ...
   Begin VB.Label lblDescription 
      Caption         =   "Programa de Edicion de Pantalla y Menus del PO900 para Controles Electronicos FERMI S.H."
      ForeColor       =   &H00000000&
      Height          =   2250
      Left            =   1890
      TabIndex        =   1
   ...
   Begin VB.Label lblDisclaimer 
      Caption         =   "Advertencia: El uso esta solo autorizado para personal de la empresa Controles Electronicos FERMI S.H."
      ForeColor       =   &H00000000&
      Height          =   435
      Left            =   240
      TabIndex        =   2
...
Private Sub Form_Load()
    ...
    lblTitle.Caption = "Windows " + App.Title
    lblDescription = lblDescription + Chr(13)
    lblDescription = lblDescription + "Direccion de Proyecto:" + Chr(13)
    lblDescription = lblDescription + "     Federico Andrades" + Chr(13)
    lblDescription = lblDescription + "Programadores:" + Chr(13)
    lblDescription = lblDescription + "     Federico Andrades" + Chr(13)
    lblDescription = lblDescription + "     Juan José Roma" + Chr(13)
    lblDescription = lblDescription + " Beta Tester :" + Chr(13)
    lblDescription = lblDescription + "     Juan José Roma" + Chr(13)
    lblDescription = lblDescription + "     Pablo Folino" + Chr(13)
